# Zishijian (藏子世间) Investor Whitepaper
...
| Platform | Type | AI Integration | Content Focus | Strengths | Weaknesses |
|----------|------|----------------|---------------|-----------|------------|
| **AI Dungeon** | Text adventure | GPT-based | Sci-fi/Fantasy | First mover, strong narrative | Limited Chinese content, basic UI |
| **Character.AI** | Character chat | Custom LLMs | Anime/Fiction | 20M MAU, strong community | Generic aesthetics, Western-centric |
| **NovelAI** | Story generation | Proprietary | Anime stories | Image generation, strong tools | High pricing, niche audience |
| **CrushOn AI** | Unfiltered chat | Various | Adult content | No restrictions | Brand risk, limited features |
| **Janitor AI** | Character creation | Various | Anime bots | Fast growth, female-skewed | Limited to bot creation |
| **Wrtn (Korean)** | Interactive stories | Custom | Romance/Drama | 2hr daily sessions, Korea #1 | US market not yet launched |
| **隐世界 (Yinshijie)** | Chinese interactive | Basic AI | Chinese mythology | Local market presence | Limited features, basic tech |

### 3.2 Zishijian Differentiation

| Factor | AI Dungeon | Character.AI | NovelAI | **Zishijian** |
|--------|-----------|--------------|---------|---------------|
...
| **Chinese Market** | Weak | Weak | Weak | **Strong positioning** |
| **Design Aesthetic** | Basic | Generic | Anime-style | **Black Myth: Wukong inspired** |
...
- 60% creator revenue sharing attracts quality content
- Distributed architecture = low marginal costs

### 4.2 Investment Thesis

**Thesis**: Zishijian is positioned to become the leading AI-powered interactive storytelling platform for Chinese mythology and original content, leveraging distributed architecture to achieve unprecedented cost efficiency and creator incentives.

**Key Assumptions**:
1. AI quality continues to improve, making interactive fiction more compelling
2. User demand for personalized, participatory content continues to grow
...
| **Fate Protagonist (命运主角)** | ✅ Live | Character selection and identity immersion |
| **World Timeline (世界时间线)** | ✅ Live | Interactive story progression and history |
| **Create Independent Universe (创造独立宇宙)** | ✅ Live | Gameified trait selection + AI-powered universe generation |
...
#### 5.2.2 Multi-AI Provider Support

Zishijian supports multiple AI providers for reliability and cost optimization:
...
1. **AI Universe Generation**
   - Users input keywords (e.g., "xianxia," "urban," "space opera")
   - AI automatically generates complete universe settings
   - Generated content: backstory, factions, rules, locations

2. **AI Character Dialogue System**
   - Real-time conversations with characters (Sun Wukong, Patriarch Subhuti, etc.)
   - Story-context memory and multi-turn understanding
   - Personality-faithful character modeling

3. **AI Story Branch Generation**
   - Dynamic story development based on user choices
   - World consistency maintenance
   - Branch visualization

4. **Enhanced User Dashboard**
   - Progress tracking across universes
...
Month 4:     AI dialogue system beta
Month 5:     AI story branching beta
Month 6:     Full platform launch with subscription system
```
...
2. **Dynamic World Evolution**
   - AI-driven world events affecting all users
   - Character state updates based on timeline
   - Inter-universe interaction events

3. **Creator Ecosystem**
   - Creator Center with full toolset
...
2. **IP Derivative Development**
   - Game adaptation partnerships
...
│(Multi-Provider)│   │  (Node/Python) │   │   (MongoDB)   │
└───────────────┘   └───────────────┘   └───────────────┘
```
...
## 8. Distributed Universe Architecture

> **Core Innovation**: Zishijian introduces a revolutionary "user-contributed compute" model, allowing creators to self-host universe nodes that other users can explore. This architecture significantly reduces platform costs while granting creators greater creative freedom.
...
- **Local Nodes**: Creators run AI on their own devices (suitable for professional creators)
- **Hybrid Mode**: Core content on cloud, heavy resources locally

#### 8.1.2 Architecture Comparison
...
|----------|----------------|-------------|
| AI Compute Cost | $1,500+ | LLM API calls for content generation |
...
### 11.1 Funding Round Overview

| Round | Amount | Purpose | Timeline |
|-------|--------|---------|----------|
| **Seed** | $500K - $2M | Product development, AI integration, initial growth | 12-18 months |

### 11.2 Use of Funds

| Category | Allocation | Description |
|----------|-----------|-------------|
| **Product Development** | 40% | AI integration, feature development, mobile apps |
| **AI Compute** | 25% | LLM API costs for platform-hosted features |
| **Marketing & Growth** | 20% | User acquisition, content creator incentives |
| **Operations** | 10% | Team expansion, legal, admin |
| **Infrastructure** | 5% | Cloud infrastructure, security |

### 11.3 Funding Milestones

| Milestone | Timeline | Funds Used | Success Metric |
|-----------|----------|------------|----------------|
...
| Year 3 | 5,000,000 | 75,000 | $2.5M | $100K/mo | Profitability |
...
**Potential Markets**:
- NASDAQ (for tech growth story)
- Hong Kong Stock Exchange (for China market alignment)
- Shanghai STAR Market (for tech-focused listing)
...
We are seeking **$500K - $2M in seed funding** to:
